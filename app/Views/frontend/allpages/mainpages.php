<div class="hero-wrap js-fullheight">
	<video autoplay muted loop class="hero-video">
		<source src="<?= base_url() ?>/public/frontend/images/background4.mp4" type="video/mp4">
	...
	<div class="container">
		<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
			<div class="col-md-7 ftco-animate">
				<span class="subheading">Welcome to <?= $city['city_name']; ?></span>
	...
	<div class="container">
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate">
				...
				<h2 class="mb-4"> <?= $city['city_name']; ?> Places</h2>
			</div>
		</div>
		<div class="row">
...
<section class="ftco-section mt-5">
	<div class="container">
		<div class="row justify-content-center pb-4">
			<div class="col-md-12 heading-section text-center ftco-animate">
				<span class="subheading">Destination</span>
				<h2 class="mb-4">Tour Destination In <?= $city['city_name']; ?></h2>
			</div>
		</div>
		<div class="row">
				<?php foreach($CityPlaceData as $cardsData)
				 {  ?>

			<div class="col-md-4 ftco-animate">
				<div class="project-wrap">
					<a href="<?=  $city['city_name'].'/'.$cardsData['slug'] ?>" class="img" style="background-image: url(<?= base_url() ?>uploads/<?= $cardsData['image'] ?>">
						<span class="price"><?=$cardsData['city_name']?></span>
					</a>
					<div class="text p-4">
						<span class="days">8 Days Tour</span>
						<h3><a href="<?= base_url('') ?>"></a></h3>
						<p class="location"><span class="fa fa-map-marker"></span><?=$cardsData['place']; ?></p>
						<ul>
