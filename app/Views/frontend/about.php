    ...
    <div class="row d-flex">
      <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
        <div class="w-100">
          ...
          <h2 class="mb-4">We are The Best Traveling Content Providing
            Company</h2>
...
<!-- hero section -->
<section class="ftco-section services-section" style="background-color: #FCFAFA;">
  <div class="container" id="about-hero5">
    <div class="row justify-content-end">
      <div class="col-lg-6 hero-img-container-about">
        <a href="./single.html">
          <div class="about-hero-img">
            <img src="<?= base_url() ?>/public/frontend/images/hero-img5.png">
          </div>
        </a>
      </div>
      ...
      <div class="col-md-12 about-intro">
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="img d-flex w-100 align-items-center justify-content-center" style="background-image:url(<?= base_url() ?>/public/frontend/images/view-mountain.jpg);">
            </div>
          </div>
          <div class="col-md-6 pl-md-5 py-5">
            <div class="row justify-content-start pb-3">
              <div class="col-md-12 heading-section ftco-animate">
                ...
                <h2 class="mb-4">Discover Your Next Adventure</h2>
                <p>Welcome to [Your Travel Website Name], where your next adventure begins. Explore breathtaking destinations, plan your perfect getaway, and create unforgettable memories. Whether you're seeking a tranquil escape, a thrilling adventure, or a cultural immersion, we've got you covered.</p>
        ...
        <div class="row">
          <div class="col-md-6 pl-md-5 py-5">
            <div class="row justify-content-start pb-3">
              <div class="col-md-12 heading-section ftco-animate">
                <!-- <span class="subheading">About Us</span> -->
                <h2 class="mb-4">Scenic Beauty of Uttarakhand</h2>
                <p>Uttarakhand, nestled in the lap of the majestic Himalayas, is a land of unparalleled natural beauty. Known as 'Dev Bhoomi' or the 'Land of the Gods,' this enchanting region offers breathtaking landscapes that captivate the soul and rejuvenate the spirit. From snow-capped peaks to lush green valleys, serene lakes to roaring rivers, Uttarakhand is a paradise for nature lovers and adventure enthusiasts alike</p>
                <p><a href="#" class="btn btn-primary">Book Your Destination</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="img d-flex w-100 align-items-center justify-content-center" style="background-image:url(<?= base_url() ?>/public/frontend/images/uttrakhandbgforab.jpg);">
            </div>
          </div>
        </div>
      </div>
