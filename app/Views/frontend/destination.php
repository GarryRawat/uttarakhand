...
<section class="ftco-intro ftco-section ftco-no-pt mt-5">
	<div class="container">
		<div class="row mt-5">
			<div class="col-md-6">Captured Your Fev Cities
					...
					<div class="gt-blog-item-4 position-relative">
						<div class="blog-img">
							<img loading="lazy" decoding="async" width="100%" height="490"
								src="<?= base_url('uploads/' . $place['image']) ?>"
								class="attachment-goyto-img-size-5 size-goyto-img-size-5 wp-post-image" alt="">
						</div>
						<div class="blog-text headline">
						<a class="read_more position-absolute" href="<?= base_url(). $place['city_name'] . '/' . $place['slug']; ?>">Read more</a>
							<h3 class="blog_title"><a
									href=""><?=$place['meta_title']?></a></h3>
							<div class="blog-meta">
								<a class="author-meta" href="#"><?=$place['place']?></a>
