        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic2">
              ...
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('insertDetails') ?>">Add Place By City</a></li>
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('listpagedetails') ?>">City And Places List</a></li>
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('addPhotos') ?>">Add City And Place Image</a></li>
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('photoslisting') ?>">List City And Place Image </a></li>
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('addfood') ?>">Add Multyple Photos</a></li>
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('food-listing') ?>">List City and Places Food</a></li>
